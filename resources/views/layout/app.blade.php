...
<html lang="en" dir="ltr" data-startbar="light" data-bs-theme="light">
    ...
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('backend/assets/libs/magic.css/magic.min.css') }}">
                    ...
                    <ul class="topbar-item list-unstyled d-inline-flex align-items-center mb-0">
                                        ...
                                        <div class="tab-pane fade show active" id="All" role="tabpanel"
                                            ...
                                            <a href="#" class="dropdown-item py-3">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-grow-1 ms-2 text-truncate">
                                                        <h6 class="my-0 fw-normal text-dark fs-13">Meeting with
                                                            designers</h6>
                                                        <small class="text-muted mb-0">It is a long established fact
                                                            that a reader.</small>
                                                    </div><!--end media-body-->
                                                </div><!--end media-->
                                            </a><!--end-item-->
                                            ...
                                            <a href="#" class="dropdown-item py-3">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-grow-1 ms-2 text-truncate">
                                                        <h6 class="my-0 fw-normal text-dark fs-13">UX 3 Task complete.
                                                        </h6>
                                            ...
                                            <a href="#" class="dropdown-item py-3">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-grow-1 ms-2 text-truncate">
                                                        <h6 class="my-0 fw-normal text-dark fs-13">Payment Successfull
                                                        </h6>
                                                        <small class="text-muted mb-0">Dummy text of the
                                                            printing.</small>
                                                    </div><!--end media-body-->
                        ...
                        <li class="dropdown topbar-item">
                            ...
                            <div class="dropdown-menu dropdown-menu-end py-0">
                                ...
                                <a class="dropdown-item" href="pages-faq.html"><i
                                        class="las la-question-circle fs-18 me-1 align-text-bottom"></i> Help
                                    Center</a>
                ...
                <div class="startbar-collapse" id="startbarCollapse" data-simplebar>
                    <div class="d-flex align-items-start flex-column w-100">
                        ...
                        <ul class="navbar-nav mb-auto w-100">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{route('teachers.index')}}" role="button" aria-expanded="false"
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{route('course.index')}}" role="button" aria-expanded="false"
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{route('students.index')}}" role="button" aria-expanded="false"
                                    aria-controls="sidebarApplications">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{route('setting.index')}}" role="button" aria-expanded="false"
                                    aria-controls="sidebarApplications">
                                    <i class="bi bi-person-vcard-fill menu-icon"></i>
                                    <span>Setting</span>
                                </a>
                            </li><!--end nav-item-->
                        ...
                        <div class="update-msg text-center">
                            ...
                            <a href="javascript: void(0);" class="btn text-primary shadow-sm rounded-pill">Upgrade
                                your plan</a>
                        </div>
                    </div>
...
{{--
        ...
        <script src="{{ asset('backend/assets/js/pages/animation.init.js') }}"></script>
    ...
    <!-- Mirrored from mannatthemes.com/rizz/default/advanced-animation.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 09 May 2025 08:19:23 GMT -->
